...
ARG eosbranch=$RELEASE_TAG
ARG rtag=$RELEASE_TAG
ARG EOSIO_DEB="./eosio.deb"
ARG EOSIO_DEB_URL="https://github.com/eosio/eos/releases/download/v${rtag}/eosio_${rtag}-1-ubuntu-18.04_amd64.deb"
